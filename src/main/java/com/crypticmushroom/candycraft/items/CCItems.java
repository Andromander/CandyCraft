...
public class CCItems {
    ...
    public static void loadItems() {
        ...
        grenadineBucket = new ItemBucket(CCBlocks.grenadine).setTranslationKey("grenadine_bucket").setCreativeTab(CandyCraft.getCandyTab()).setContainerItem(Items.BUCKET);
        ...
        honeyBolt = new Item().setTranslationKey("honey_bolt").setCreativeTab(CandyCraft.getCandyTab());
        caramelCrossbow = new ItemCandyCrossbow().setTranslationKey("caramel_crossbow").setCreativeTab(CandyCraft.getCandyTab());

        CD1 = new ItemCandyRecord(C1, "C418 - Sweden - Remix Caution & Crisis", "Sweden Remix").setTranslationKey("record_1").setCreativeTab(CandyCraft.getCandyTab());
        CD2 = new ItemCandyRecord(C2, "Jakim - Every", "Every").setTranslationKey("record_2").setCreativeTab(CandyCraft.getCandyTab());
        CD3 = new ItemCandyRecord(C3, "Rainbow Bunchie", "Rainbow Bunchie").setTranslationKey("record_3").setCreativeTab(CandyCraft.getCandyTab());
        CD4 = new ItemCandyRecord(C4, "C418 - Einfallslos", "Einfallslos").setTranslationKey("record_4").setCreativeTab(CandyCraft.getCandyTab());
