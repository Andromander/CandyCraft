...
public class CCBlocks {
    ...
    public static void loadBlocks() {
        ...
        marshmallowStairs = new BlockCandyStairs(marshmallowPlanks.getStateFromMeta(0), SoundType.WOOD).setTranslationKey("marshmallow_stairs").setCreativeTab(CandyCraft.getCandyTab()).setHardness(3.0F).setResistance(5.0F);
        marshmallowStairs2 = new BlockCandyStairs(marshmallowPlanks.getStateFromMeta(1), SoundType.WOOD).setTranslationKey("dark_marshmallow_stairs").setCreativeTab(CandyCraft.getCandyTab()).setHardness(3.0F).setResistance(5.0F);
        marshmallowStairs3 = new BlockCandyStairs(marshmallowPlanks.getStateFromMeta(2), SoundType.WOOD).setTranslationKey("light_marshmallow_stairs").setCreativeTab(CandyCraft.getCandyTab()).setHardness(3.0F).setResistance(5.0F);
        marshmallowHalfStep = (BlockSlab) new BlockCandyStep(Material.WOOD, false, 0, SoundType.WOOD).setTranslationKey("marshmallow_slab").setCreativeTab(CandyCraft.getCandyTab()).setHardness(3.0F).setResistance(5.0F);
        marshmallowStep = (BlockSlab) new BlockCandyStep(Material.WOOD, true, 0, SoundType.WOOD).setTranslationKey("marshmallow_double_slab").setHardness(3.0F).setResistance(5.0F);
        marshmallowHalfStep2 = (BlockSlab) new BlockCandyStep(Material.WOOD, false, 4, SoundType.WOOD).setTranslationKey("dark_marshmallow_slab").setCreativeTab(CandyCraft.getCandyTab()).setHardness(3.0F).setResistance(5.0F);
        marshmallowStep2 = (BlockSlab) new BlockCandyStep(Material.WOOD, true, 4, SoundType.WOOD).setTranslationKey("dark_marshmallow_double_slab").setHardness(3.0F).setResistance(5.0F);
        marshmallowHalfStep3 = (BlockSlab) new BlockCandyStep(Material.WOOD, false, 5, SoundType.WOOD).setTranslationKey("light_marshmallow_slab").setCreativeTab(CandyCraft.getCandyTab()).setHardness(3.0F).setResistance(5.0F);
        marshmallowStep3 = (BlockSlab) new BlockCandyStep(Material.WOOD, true, 5, SoundType.WOOD).setTranslationKey("light_marshmallow_double_slab").setHardness(3.0F).setResistance(5.0F);
        ...
        candyCaneHalfStep = (BlockSlab) new BlockCandyStep(Material.WOOD, false, 2, SoundType.STONE).setTranslationKey("candy_cane_slab").setCreativeTab(CandyCraft.getCandyTab()).setHardness(1.0F).setResistance(2.0F);
        candyCaneStep = (BlockSlab) new BlockCandyStep(Material.WOOD, true, 2, SoundType.STONE).setTranslationKey("candy_cane_double_slab").setHardness(1.0F).setResistance(2.0F);
        ...
        cottonCandyHalfStep = (BlockSlab) new BlockCandyStep(Material.CLOTH, false, 3, SoundType.CLOTH).setTranslationKey("cotton_candy_slab").setCreativeTab(CandyCraft.getCandyTab()).setHardness(3.0F).setResistance(5.0F);
        cottonCandyStep = (BlockSlab) new BlockCandyStep(Material.CLOTH, true, 3, SoundType.CLOTH).setTranslationKey("cotton_candy_double_slab").setHardness(3.0F).setResistance(5.0F);
        ...
        caramelGlass0 = new BlockCandyGlass(Material.GLASS).setSilkHarvest(true).setDroppedItem(null).setLightOpacity(0).setHardness(0.3F).setTranslationKey("caramel_glass").setCreativeTab(CandyCraft.getCandyTab());
        caramelGlass1 = new BlockCandyGlass(Material.GLASS).setSilkHarvest(true).setDroppedItem(null).setLightOpacity(0).setHardness(0.5F).setTranslationKey("caramel_glass_round").setCreativeTab(CandyCraft.getCandyTab());
        caramelGlass2 = new BlockCandyGlass(Material.GLASS).setSilkHarvest(true).setDroppedItem(null).setLightOpacity(0).setHardness(0.7F).setTranslationKey("caramel_glass_diamond").setCreativeTab(CandyCraft.getCandyTab());
        caramelPane0 = new BlockCandyGlassPane(Material.GLASS, false).setHardness(0.3F).setTranslationKey("caramel_pane").setCreativeTab(CandyCraft.getCandyTab());
        caramelPane1 = new BlockCandyGlassPane(Material.GLASS, false).setHardness(0.5F).setTranslationKey("caramel_pane_round").setCreativeTab(CandyCraft.getCandyTab());
        caramelPane2 = new BlockCandyGlassPane(Material.GLASS, false).setHardness(0.7F).setTranslationKey("caramel_pane_diamond").setCreativeTab(CandyCraft.getCandyTab());
        ...
        iceCreamStairs0 = new BlockCandyStairs(iceCream.getStateFromMeta(0), SoundType.SNOW).setTranslationKey("strawberry_ice_cream_stairs").setCreativeTab(CandyCraft.getCandyTab()).setHardness(1.0F);
        iceCreamStairs1 = new BlockCandyStairs(iceCream.getStateFromMeta(1), SoundType.SNOW).setTranslationKey("mint_ice_cream_stairs").setCreativeTab(CandyCraft.getCandyTab()).setHardness(1.0F);
        iceCreamStairs2 = new BlockCandyStairs(iceCream.getStateFromMeta(2), SoundType.SNOW).setTranslationKey("blueberry_ice_cream_stairs").setCreativeTab(CandyCraft.getCandyTab()).setHardness(1.0F);
        iceCreamStairs3 = new BlockCandyStairs(iceCream.getStateFromMeta(3), SoundType.SNOW).setTranslationKey("ice_cream_stairs").setCreativeTab(CandyCraft.getCandyTab()).setHardness(1.0F);
        iceCreamHalfStep0 = (BlockSlab) new BlockCandyStep(Material.SAND, false, 6, SoundType.SNOW).setTranslationKey("strawberry_ice_cream_slab").setCreativeTab(CandyCraft.getCandyTab()).setHardness(1.0F);
        iceCreamStep0 = (BlockSlab) new BlockCandyStep(Material.SAND, true, 6, SoundType.SNOW).setTranslationKey("strawberry_ice_cream_double_slab").setHardness(1.0F);
        iceCreamHalfStep1 = (BlockSlab) new BlockCandyStep(Material.SAND, false, 7, SoundType.SNOW).setTranslationKey("mint_ice_cream_slab").setCreativeTab(CandyCraft.getCandyTab()).setHardness(1.0F);
        iceCreamStep1 = (BlockSlab) new BlockCandyStep(Material.SAND, true, 7, SoundType.SNOW).setTranslationKey("mint_ice_cream_double_slab").setHardness(1.0F);
        iceCreamHalfStep2 = (BlockSlab) new BlockCandyStep(Material.SAND, false, 8, SoundType.SNOW).setTranslationKey("blueberry_ice_cream_slab").setCreativeTab(CandyCraft.getCandyTab()).setHardness(1.0F);
        iceCreamStep2 = (BlockSlab) new BlockCandyStep(Material.SAND, true, 8, SoundType.SNOW).setTranslationKey("blueberry_ice_cream_double_slab").setHardness(1.0F);
        iceCreamHalfStep3 = (BlockSlab) new BlockCandyStep(Material.SAND, false, 9, SoundType.SNOW).setTranslationKey("ice_cream_slab").setCreativeTab(CandyCraft.getCandyTab()).setHardness(1.0F);
        iceCreamStep3 = (BlockSlab) new BlockCandyStep(Material.SAND, true, 9, SoundType.SNOW).setTranslationKey("ice_cream_double_slab").setHardness(1.0F);
